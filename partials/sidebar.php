...
<?php if ($usertype=='bookie') {
  echo '<!--==== accordion list-3 =====-->
  <li class="nav-item accordion-content hide">
  <h3 class="title"><i class="fas fa-cog"></i> User options</h3>
  <ul class="description navbar-nav">
  
       <li class="nav-item">
        <a class="nav-link content-link" href="dashboard.php?cat=website-user&subcat=user-transfer">Transfer user balance</a>
      </li>
...
<?php if ($usertype=='admin') {
   echo '<li class="nav-item accordion-content hide">
...
<?php if ($usertype=='admin') {
 echo '<li class="nav-item accordion-content hide">
      <h3 class="title"><i class="fas fa-user-cog"></i> Bookie settings</h3>
      <ul class="description navbar-nav">
        <li class="nav-item">
            <a class="nav-link content-link" href="dashboard.php?cat=website-bookie&subcat=bookie-profile">Bookie Profile</a>
          </li>
      </ul>
      </li>';
}
