...
<div class="container-fluid bg-secondary menu sticky-top" style="background-color: <?php echo $navbarBackground; ?>!important">
    ...
    <li class="nav-item">
          <?php
          if ($usertype=='admin') {
            echo '<h4 class="text-light" style="position: relative;top: 8px">Admin Panel</h3>';
          }
          else{
            echo '<h4 class="text-light" style="position: relative;top: 8px">Bookie Panel</h3>';
          }
          ?>
    ...
    <?php
      if ($usertype=='admin') {
        ...
        echo '<a href="dashboard.php?cat=setting&subcat=admin-panel" class="nav-link content-link" title="setting"><i class="fas fa-cog"></i></a>';
        echo '</li>';
      }
      ?>
    <!-- <li class="nav-item">
